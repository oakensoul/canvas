...
This skill provides factual information about canvas's structure,
...
**README:** `README.md` (748 chars - Minimal - README and inline comments)
...
CLI built with Click, Rich for terminal output. See docs/architecture/README.md for full architecture including session lifecycle, registry schema, slug generation, CLAUDE.md templates, and iTerm2 integration.
...
---
*Auto-generated by AIDA configure for canvas*

*Detected facts: 2026-03-13T12:21:12.677462*

*This skill is automatically activated when working in canvas*